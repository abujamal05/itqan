  ...
  return (
    <section className="stack" aria-labelledby="journey-title">
      ...
      <MapCanvas
        ...
        edges={edges}
        nodeTypes={nodeTypes}
        fitKey={`${locale}:${stages.length}:${low}`}
        /* Four milestones are the whole story, so this fits wherever it can
           legibly fit. Where it cannot — a phone — it opens on where the user
           actually is and the rest is a pan away. */
