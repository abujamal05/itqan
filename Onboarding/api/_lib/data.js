 ...
 *
 * Ported verbatim from dev/data.ts so the deployed app shows the same
 * fixtures as local dev. Plain JS on purpose: Vercel runs api/ files as-is,
 * and a TypeScript build step here would be one more thing to break.
 */
const pick = (b, l) => b[l];

export const analysisResult = (l) => ({
  fullName: {
